	...
	SubShader
	{
		...
		Pass
		{
			...
			v2f vert(uint id : SV_VertexID, uint inst : SV_InstanceID)
			{
				...
				o.color = float4(plantParticleData.nutrientsUsed, 0, plantParticleData.wasteProduced * 1.15, plantParticleData.isActive); // float4(particleData.age, particleData.algaeConsumed, 1, particleData.isActive);
