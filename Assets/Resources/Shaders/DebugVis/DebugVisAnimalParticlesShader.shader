Shader "DebugVis/DebugVisAnimalParticlesShader"
{
	Properties
	{
	...
	{		
		...
		Pass
		{
			...
			v2f vert(uint id : SV_VertexID, uint inst : SV_InstanceID)
			{
				...
				o.color = float4(particleData.isActive, saturate(particleData.biomass), saturate(particleData.isDecaying), saturate(particleData.age * 0.5));
