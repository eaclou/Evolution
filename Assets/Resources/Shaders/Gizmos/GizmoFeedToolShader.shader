Shader "Gizmos/GizmoFeedToolShader"
{
	Properties
	{
	...
	{		
		...
		Pass
		{
			...
			v2f vert(uint id : SV_VertexID, uint inst : SV_InstanceID)
			{
				...
				//radiusMult *= (1.0 + _IsStirring * 0.05);
			...
			fixed4 frag(v2f i) : SV_Target
			{
				...
				float4 idleColor = float4(0.5, 1.25, 0.7, 1);
				float4 activeColor = float4(0.7, 1.5, 0.82, 1);
