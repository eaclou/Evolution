	...
	{		
		...
		Pass
		{
			...
			fixed4 frag(v2f i) : SV_Target
			{
				...
				finalGrowColor.rgb = float3(1.75,2.35,0.65) * lerp(saturate(i.color.z * 0.6 + 0.2), 1, saturate(1.0 - rawData.foodAmount.r));
				...
				//finalGrowColor.rgb = lerp(finalGrowColor.rgb, float3(0.7,1,0.1), 0.25);
