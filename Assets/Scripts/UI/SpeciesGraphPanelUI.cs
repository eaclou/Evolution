...
public class SpeciesGraphPanelUI : MonoBehaviour
{
    ...
    public void UpdateSpeciesTreeDataTextures(int year) {  // refactor using year?
        ...
        for(int i = 0; i < masterGenomePool.currentlyActiveSpeciesIDList.Count; i++) {
            ...
            keyData.isSelected = (simulationManager.uiManager.selectedSpeciesID == masterGenomePool.currentlyActiveSpeciesIDList[i]) ? 1f : 0f;
        ...
        for(int i = numTotalSpecies - 1; i > Mathf.Clamp((numTotalSpecies - maxDisplaySpecies), 0, numTotalSpecies); i--) {
            ...
            keyData.isSelected = simulationManager.uiManager.selectedSpeciesID == i ? 1f : 0f;
    ...
    private void RefreshGraphMaterial() {
        ...
        switch(selectedGraphCategory) {
            case GraphCategory.Life:
                ...
                speciesGraphMatLeft.SetInt("_SelectedSpeciesID", simulationManager.uiManager.selectedSpeciesID);
                ...
                speciesGraphMatCenter.SetInt("_SelectedSpeciesID", simulationManager.uiManager.selectedSpeciesID);
                ...
                speciesGraphMatRight.SetInt("_SelectedSpeciesID", simulationManager.uiManager.selectedSpeciesID);
